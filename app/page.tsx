        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/pricing">
                <Button size="lg" variant="gradient" className="w-full sm:w-auto bg-gradient-to-r from-purple-600 to-blue-600 hover:shadow-xl transition-all">
                  Start Certification — from $299/mo
                </Button>
              </Link>
              <Link href="/verify">
